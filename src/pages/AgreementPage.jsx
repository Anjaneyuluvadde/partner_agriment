...
export default function AgreementPage() {
  ...
  const handleDownloadPdf = () => {
    ...
    // Add PDF mode class to hide input borders
    element.classList.add('pdf-mode');

    // Production level fix: convert all inputs to spans for perfect PDF rendering
    ...
    const opt = {
      margin:       10,
      filename:     'Service_Partner_Agreement.pdf',
  ...
  return (
    ...
    <div className="agreement-wrapper" style={{ margin: '0 auto' }} ref={componentRef}>
      ...
      <div style={{ background: '#f8fcff', padding: '1rem 1.5rem', borderRadius: '20px', margin: '1.2rem 0' }}>
      ...
      <div style={{ background: '#eaf2f9', padding: '1.2rem 1.8rem', borderRadius: '20px', margin: '1.5rem 0' }}>
      ...
      <div className="annex-box">
        ...
        <div style={{ background: '#f2f8fd', padding: '1rem 1.5rem', borderRadius: '18px', margin: '1.2rem 0' }}>
          <p><strong>PARTNER DETAILS</strong><br />
          Partner Name: <input type="text" className="dotted-field" /><br />
